		...
		while (menu != 9) {
			...
			if (menu == 1) {
				...
				if (comorbidade == 2 && idade >= 18) {
					System.out.print("Pessoas sem comorbidade ainda deverão esperar pela data de sua faixa etária ou profissão. ");
				}
			...
			if (menu == 2) {
				...
				if (menu == 3) {
					...
					System.out.println("");
					System.out.println("Obrigado por utilizar nosso programa, tenha um ótimo dia.");
				}
